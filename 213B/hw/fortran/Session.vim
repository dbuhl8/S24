...
inoremap <expr> 	 coc#pum#visible() ? coc#pum#next(1) : "\	"
...
set mouse=a
set ruler
set runtimepath=~/.vim,~/.vim/plugged/onedark.vim,~/.vim/plugged/onehalf/vim,~/.vim/plugged/lightline.vim,~/.vim/plugged/vim-tmux-navigator,~/.vim/plugged/vimtex,~/.vim/plugged/nerdtree,~/.vim/plugged/fzf,~/.vim/plugged/fzf.vim,~/.vim/plugged/coc.nvim,~/.vim/plugged/vim-obsession,/usr/share/vim/vimfiles,/usr/share/vim/vim91,/usr/share/vim/vimfiles/after,~/.vim/plugged/vimtex/after,~/.vim/after
set shiftwidth=4
set noshowmode
set smartcase
...
silent only
silent tabonly
cd ~/Documents/S24/213B/hw/fortran
...
badd +11 LinAl.f90
badd +1 NumDE.f90
badd +1 hw3_driver.f90
argglobal
%argdel
$argadd LinAl.f90
$argadd NumDE.f90
$argadd hw3_driver.f90
edit hw3_driver.f90
...
argglobal
if bufexists(fnamemodify("hw3_driver.f90", ":p")) | buffer hw3_driver.f90 | else | edit hw3_driver.f90 | endif
balt NumDE.f90
nnoremap <buffer> 	 >>
vnoremap <buffer> ( c()P
nnoremap <buffer> C ^x$
nnoremap <buffer> \n i&
nnoremap <buffer> c I!$
iabbr <buffer> ra real, allocatable :: 
iabbr <buffer> rd real, dimension() :: F)i
iabbr <buffer> lg logical ::
iabbr <buffer> int integer ::
iabbr <buffer> fct :set autoindent Afunctionimplicit noneend function:set noautoindent kkkkA
iabbr <buffer> pg :set autoindent Aprogramimplicit noneend program:set noautoindent kkkkA
iabbr <buffer> md :set autoindent Amoduleimplicit noneend module:set noautoindent kkkkA
iabbr <buffer> sr :set autoindent Asubroutineimplicit noneend subroutine :set noautoindent kkkkA
iabbr <buffer> do :set autoindent Adoend do :set noautoindent kkA
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
if bufexists(fnamemodify("LinAl.f90", ":p")) | buffer LinAl.f90 | else | edit LinAl.f90 | endif
nnoremap <buffer> 	 >>
vnoremap <buffer> ( c()P
nnoremap <buffer> C ^x$
nnoremap <buffer> \n i&
